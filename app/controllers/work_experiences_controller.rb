class WorkExperiencesController < ApplicationController
  ...
  def create
    ...
    if @work_experience.save
      render_turbo_stream('append', 'work_experience_items',
                        'work_experiences/work_experience', { work_experience: @work_experience })
    else
      render_turbo_stream('replace', 'remote_modal', 'shared/turbo_modal', 
  ...
  def update
    if @work_experience.update work_experience_params 
      render_turbo_stream('replace', "work_experience_item_#{@work_experience.id}",
                      'work_experiences/work_experience', { work_experience: @work_experience })
    else
