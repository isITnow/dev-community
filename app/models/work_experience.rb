class WorkExperience < ApplicationRecord
  ...
  validates :company, :start_date, :job_title,
  ...
  def presence_of_end_date
    if currently_not_working_here? && end_date.nil?
  ...
  def job_duration
    months = end_date.present? ? fech_months(end_date) : fech_months(Date.today)
